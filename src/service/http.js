...
export function getLendlist(npage, pagesize, begainTimeString, endTimeString, orderType, cash_outType, phonenumber, userName) {
  let data = {
    npage,
    pagesize,
    begainTimeString,
...
export function httpCollectremain() {
  return axios({
