  ...
  <el-tabs v-model="activeName" type="border-card" class="m20" @tab-click="handleClick" v-loading="lodings">
    <el-tab-pane label="进行中催收订单" name="first">
        ...
        <el-table
          ...
          >
            <el-table-column prop="id" fixed label="订单号" align="center"  width="70" >
            ...
            <el-table-column prop="idNo" label="身份证号" align="center" min-width="150">
                        <template slot-scope="scope">
                          <el-tooltip class="item" effect="dark" :content="scope.row.idNo" placement="top">
                              <span>{{scope.row.idNo}}</span>
                          </el-tooltip>
                    </template> 	    
	    </el-table-column>
            <el-table-column prop="collectEntructId" label="外包情况" align="center" min-width="70" >
              <template slot-scope="scope">
                            <el-tag
            ...
            <el-table-column prop="applyTime" label="申请时间" align="center" min-width="90" >
                <template slot-scope="scope">
                    {{scope.row.applyTime|dateServer2}}
                </template>

                
            </el-table-column>
            <!-- <el-table-column prop="approveAmt" label="审核金额" align="center"   widt="100" ></el-table-column> -->
            <el-table-column prop="updateTime" label="最后催收时间" align="center" min-width="100" >
                <template slot-scope="scope">
                  <template v-if="scope.row.updateTime">
                    {{scope.row.updateTime|dateServer2}}
                  </template>
                </template>
            </el-table-column>
<el-table-column prop="allOverdueBenjinMoney" label="本金额度" align="center" min-width="70"></el-table-column>
<el-table-column prop="allOverdueDaoZhangMoney" label=" 实际到账金额" align="center" min-width="100"></el-table-column>
                      <el-table-column prop="result" label="最后催收结果" align="center" min-width="100">
                        <template slot-scope="scope">
            ...
            <el-table-column type="expand" label="详情" min-width="60" >
              <template slot-scope="props" >
                ...
                <el-table
                  ...
                  >
                      ...
                      <el-table-column prop="withdrawMoney" label="实际到账金额" align="center"  ></el-table-column>
                      <el-table-column prop="raiseMoney" label="提现金额" align="center"  ></el-table-column>
                      <el-table-column prop="borrowTime" label="提现时间" align="center"   width="100">
                        <template slot-scope="scope">
                            {{scope.row.creatime|dateServer2}}
                        </template>                          
                      </el-table-column>
                      <el-table-column prop="borrowTime" label="应还款时间" align="center"   width="100">
                        <template slot-scope="scope">
                      ...
                      <el-table-column  prop="overdue.overdueDay" label="逾期天数" align="center"  ></el-table-column>
                      <el-table-column  prop="overdue.lateFee" label="违约金" align="center"  ></el-table-column>
                ...
                <template slot-scope="scope">
                    {{scope.row.createTime|dateServer2}}
                </template>                              
                            </el-table-column>                      
                ...
                <el-table-column prop="cz"  align="center" label="操作"  min-width="280" >
                    <template slot-scope="scope">
                    <el-button
                        size="mini"
                        type="success"
    ...
    <el-tab-pane label="已完成催收订单" name="second">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column fixed prop="id" label="订单号" align="center"  width="70"  >
                                      <template slot-scope="scope">
                                              <el-tooltip class="item" effect="dark" :content="scope.row.id" placement="top">
                                                  <span>{{scope.row.id}}</span>
                                              </el-tooltip>
            ...
            <!-- <el-table-column prop="approveAmt" label="审核金额" align="center" width="100"   ></el-table-column> -->
            <el-table-column prop="updateTime" label="最后催收时间" align="center" min-width="100"  >
                <template slot-scope="scope">
                  <template v-if="scope.row.updateTime">
                    {{scope.row.updateTime|dateServer2}}
            ...
            <el-table-column type="expand" label="详情" min-width="60" >
              <template slot-scope="props" >
                ...
                <el-table-column prop="cz"  align="center" label="操作"  min-width="300" >
                    <template slot-scope="scope">
                       <el-button type="danger"  :disabled="scope.row.userStatus==1?false:true" @click="handleDongjie(scope.row)">
                         {{scope.row.userStatus==1?'冻结':'已冻结'}}
                         </el-button>                       
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="approveAmt" label="审核金额" align="center"   ></el-table-column>
            <el-table-column type="expand" label="详情" width="80" >
              <template slot-scope="props" >
                ...
                <el-table
                  ...
                  >
                      <el-table-column prop="id" label="id" align="center"  ></el-table-column>
                      <el-table-column prop="withdrawMoney" label="提现金额" align="center"  ></el-table-column>
                      <el-table-column prop="borrowTime" label="提现时间" align="center"  >
                        <template slot-scope="scope">
                            {{scope.row.borrowTime|dateServer2}}
                        </template>                          
                      </el-table-column>
                      <el-table-column prop="status" label="是否逾期" align="center" 
                         :filters="[{ value: 0, text: '放款中 ' }, { value: 1, text: '放款成功' }, { value: 2, text: '逾期' }, { value: 3, text: '还款成功' }, { value: 4, text: '放款失败' }, { value: 5, text: '还款中' }, { value: 6, text: '还款失败' }]"
        ...
        <el-dialog
         ...
         >
                ...
                <table class="table textContent" >
                    ...
                    <tr>
                        ...
                        <td colspan="5" >
                          ...
                          <template slot-scope="scope">
                                                                        <el-tag
                                       :type="scope.row.chbstatus===1?'success':scope.row.chbstatus===0?'danger':''">
                                       {{scope.row.chbstatus===1?'正常':scope.row.chbstatus===0?'冻结':''}}
                                       </el-tag>
                                               </template>  
                                </el-table-column>
            ...
            <template slot-scope="scope">
                                ...
                                <el-table-column prop="ip" align="center" label="创建时间"  width="100">
                 <template slot-scope="scope">
                                 {{scope.row.chbcreateTime | dateServer2}}
                                               </template>  
         ...
         >
          <el-tabs v-model="activeName1" @tab-click="handleClick1">
                ...
                <el-card >
                    <div class="xy_card">
                        <div>
                            <dl>
                                <dt>客户基本资料</dt>
                                <dd>姓名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{userBasicInformation.name}}</span></dd>
                                <dd>手机号：&nbsp;&nbsp;&nbsp;<span>{{userBasicInformation.cellPhone}}</span></dd>
                                <dd>身份证号：<span>{{userBasicInformation.idcard}}</span></dd>
                            </dl>
                        </div>
                        <div>
            ...
            <!-- <el-row class="flx">
                ...
                <div class="fr">
                    报告时间:<span>{{new Date() |dateServer2}}</span>
                </div>
            </el-row>   
            <el-row v-if="reportList">
                <el-card>
                  ...
                  <el-row style="padding-top:0;position:relative;">
                    ...
                    <el-row class="report_t">
                      ...
                      <div class="el-main-info r">
                        <span>报告生成时间：{{new Date() |dateServer2}} 11:19:37</span>
                      </div>
                      ...
                      <table cellpadding="0" cellspacing="0" class="table">
                        ...
                        <tr>
                          <td>
                            ...
                            <span>注册时间：</span>
                            <span>{{userBasicInformation.regTime |  dateServer2}}</span>
                            <!-- <span class="tip_y"></span> -->
                    ...
                    <el-card class="el-card" v-if="operatorDataTableData.length>0">
                      ...
                      <template v-if="yysShow">
                          <el-table :data="operatorDataTableData.slice(0,5)" >
                            ...
                            <el-table-column prop="callOutCnt" align="center" min-width="100" label="主叫次数"  >
                            </el-table-column>
                            <el-table-column prop="callInCnt" align="center" min-width="100" label="被叫次数"  >
                            </el-table-column>
