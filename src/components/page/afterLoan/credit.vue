<template>
    <div class="container">
        ...
        <el-table
            ...
            v-loading="loading"
          >
            <el-table-column fixed prop="id" label="订单号" align="center"   width="70"></el-table-column>
            ...
            <el-table-column prop="applyAmt" label="申请金额" align="center" min-width="70"  ></el-table-column>
            <el-table-column prop="approveAmt" label="总额度" align="center" min-width="60"   ></el-table-column>
            <el-table-column prop="status" label="订单状态" align="center" min-width="90" 
          ...
          <el-table-column prop="residue_amt" label="剩余额度" align="center" min-width="70"  ></el-table-column>
              ...
              <template slot-scope="props" >
                ...
                <el-table
                  ...
                  >
                      ...
                      <el-table-column prop="borrowTime" label="提现时间" align="center"   width="120">
                        <template slot-scope="scope">
                      ...
                      <el-table-column prop="realRepaymentTime" label="还款时间" align="center"   width="120">
                        <template slot-scope="scope">
                          <template v-if="scope.row.overdue">
                            {{scope.row.overdue.realRepaymentTime|dateServer}}
                          </template>
                        </template>                          
                      </el-table-column>
                      <el-table-column prop="return_day" label="应还款时间" align="center"   width="120">
                        <template slot-scope="scope">
    ...
    export2Excel() {
      require.ensure([], () => {
        ...
        for (var i = 0; i < list.length; i++) {
          list[i].status = list[i].status === 0 ? "正常" : "逾期";
          list[i].cash_outType =
