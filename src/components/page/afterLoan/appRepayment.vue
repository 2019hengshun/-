<template>
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="realRepaymentTime" label="实际还款时间" align="center" min-width="140"  >
                <template slot-scope="scope">
            ...
            <el-table-column prop="raise_money" label="客户提现金额" align="center" min-width="95"  ></el-table-column>             
            <el-table-column prop="return_money" label="本金逾期金额" align="center" min-width="95"  ></el-table-column>
       <el-table-column prop="reduce_money" label="减免金额" align="center" min-width="70"  ></el-table-column> 
    ...
    <el-table-column prop="overdue_day" label="M值" align="center" min-width="70">
                      <template slot-scope="scope">
            ...
            <el-table-column prop="collectorName" label="催收员" align="center" min-width="70"></el-table-column>
