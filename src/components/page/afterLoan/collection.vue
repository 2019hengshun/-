    ...
    <div class="container">
        ...
        <el-row class="m20" >
            ...
            <el-col  :span="24" class="col-flex-end">
                    <el-button-group>
                      <el-button :type="execeedtimeType==0?'info':''" @click="changeExeceedtimeType(0,false)">重置</el-button>
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="applyTime" label="申请时间" align="center" min-width="140"  >
                <template slot-scope="scope">
                    {{scope.row.applyTime|dateServer}}
                </template>
            </el-table-column>
            <el-table-column prop="approveAmt" label="审核金额" align="center"   min-width="70"></el-table-column>
            <el-table-column prop="collectorUserName" label="催收员" align="center"  min-width="60">
                <template slot-scope="scope">
        ...
        <el-row class="m20" >
            <el-col   class="col-flex-end">
                    <el-button-group>
                      <el-button :type="execeedtimeType==0?'info':''" @click="changeExeceedtimeType(0,true)">重置</el-button>
        ...
        <el-table
          ...
          >
                ...
                <template slot-scope="scope">
                  <template v-if="scope.row.updateTime">
                      {{scope.row.updateTime|dateServer}}
                        ...
                        <el-table-column prop="updateCollectTime" label="最后分配时间" align="center" min-width="140"  >
                <template slot-scope="scope">
            ...
            <el-table-column prop="applyCollectResultStatus" label="催收结果" align="center" min-width="80" >
                        <template slot-scope="scope">
            ...
            <el-table-column prop="collectorUserName" label="催收员" align="center"  min-width="80">
                <template slot-scope="scope">
                    {{scope.row.collectorUserName?scope.row.collectorUserName:'暂无催收员'}}
                </template>
            </el-table-column> 
            <el-table-column prop="collectorId" label="催收员ID" align="center" min-width="70" >
            </el-table-column>   
...
export default {
  ...
  methods: {
    ...
    changeExeceedtimeType(i, type) {
      if (i == 0) {
        this.collectorId = null;
        this.search = {};
      }
      if (type) {
        this.execeedtimeType = 5;
      } else {
