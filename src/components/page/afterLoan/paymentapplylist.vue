    ...
    <div class="container">
        ...
        <el-table
         ...
         <el-table-column prop="userName" label="姓名" align="center" min-width="70"   ></el-table-column>
            ...
            <el-table-column prop="collectName" label="催收员" align="center"  min-width="60"></el-table-column>
            ...
            <el-table-column prop="createTime" label="提现时间" align="center" min-width="140"   >
                <template slot-scope="scope">
                    {{scope.row.createTime|dateServer}}
                      ...
                      <el-table-column prop="cz"  align="center" label="操作"  min-width="100" v-if="activename=='first'">
                          <template slot-scope="scope">
                          <el-button
                              size="mini"
                              ...
                              @click="handlehk(scope.$index, scope.row)"
                                   :disabled="scope.row.status!==3 &&scope.row.status!==2 && scope.row.status!==6 && scope.row.status!==null"
                             >还款申请
            ...
            <el-table-column prop="collectName" label="催收员" align="center" min-width="120"   ></el-table-column>
