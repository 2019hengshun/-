    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="username" label="手机号" align="center"    width="140"></el-table-column>            
            <el-table-column prop="creatime" label="创建时间" align="center" width="180"  >
            ...
            <el-table-column prop="serialNumber" label="设备号" align="center"   ></el-table-column>
