    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="couponValue" label="优惠卷面值" align="center" min-width="90" >
            </el-table-column>   
            <el-table-column prop="couponIntervalMin" label="区间值最小" align="center"  min-width="90" >
            </el-table-column>   
            <el-table-column prop="couponIntervalMax" label="区间值最大" align="center"  min-width="90" >
            </el-table-column>   
            <el-table-column prop="couponTitle" label="优惠券标题" align="center"  min-width="120" >
            </el-table-column>   
            <el-table-column prop="extinctTime" label="失效天数" align="center"  min-width="70" >
            </el-table-column> 
            <el-table-column prop="creteTime" label="创建时间" align="center"  min-width="140">
            ...
            <el-table-column prop="status" label="是否删除" align="center"  min-width="70" >
                  <template slot-scope="scope">
                      <el-tag
            ...
            <el-table-column prop="imageUrl " label="样式" align="center"  min-width="180" >
                  <template slot-scope="scope">
