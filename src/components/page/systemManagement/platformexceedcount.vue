<template>
   ...
   <el-row class="m20">
      ...
      <el-table
        ...
        <el-table-column prop="applyNumber"  align='center' label="订单量" min-width="80"></el-table-column>
        <el-table-column prop="allSalesMoney" align='center' label="销售额" min-width="90"></el-table-column>
        <el-table-column prop="readyCollectionMoney" align='center' label="待收款" min-width="90"></el-table-column>

        <el-table-column prop="allLate_free" align='center' label="M1">
            <el-table-column prop="overdueApplyNumber_m1"  align='center' label="数量" min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney_m1" align='center' label="金额" min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney" align='center' label="比例" min-width="70">
        ...
        <el-table-column prop="allLate_free" align='center' label="M2">
            <el-table-column prop="overdueApplyNumber_m2"  align='center' label="数量"  min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney_m2" align='center' label="金额"  min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney" align='center' label="比例"  min-width="70">
                <template slot-scope="scope">
        ...
        <el-table-column prop="allLate_free" align='center' label="M3">
            <el-table-column prop="overdueApplyNumber_m3"  align='center' label="数量"  min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney_m3" align='center' label="金额"  min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney" align='center' label="比例"  min-width="70">
                <template slot-scope="scope">
        ...
        <el-table-column prop="allLate_free" align='center' label="M3+">
            <el-table-column prop="overdueApplyNumber_m4"  align='center' label="数量"  min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney_m4" align='center' label="金额"  min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney" align='center' label="比例"  min-width="70">
                <template slot-scope="scope">
        ...
        <el-table-column prop="allLate_free" align='center' label="小计">
            <el-table-column prop="overdueApplyNumber_m1"  align='center' label="数量"  min-width="70">
                <template slot-scope="scope">
            ...
            <el-table-column prop="allOverdueMoney_m1" align='center' label="金额"  min-width="70">
                <template slot-scope="scope">
