    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="creatime" label="创建时间" align="center" min-width="140"  >
            ...
            <el-table-column prop="status" label="状态" align="center" 
                ...
                :filter-method="filterStauts"    min-width="100"
            ...
            <el-table-column prop="cz"  align="center" label="操作"  min-width="180" >
                <template slot-scope="scope">
                <el-button
                    size="mini"
                    type="success"
