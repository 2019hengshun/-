    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="rid" fixed label="ID" align="center" width="70"></el-table-column>
            <el-table-column prop="rname" label="角色名字" align="center" min-width="140"></el-table-column>
            <el-table-column prop="createtime" label="创建时间" align="center" min-width="140"  >
                <template slot-scope="scope">
                    {{scope.row.createtime|dateServer}}
                </template>
            </el-table-column>
            <el-table-column prop="jobTitle" label="备注" align="center" min-width="120"></el-table-column>
