...
<template>
    <div class="container">
        ...
        <el-table
            ...
            <el-table-column prop="overdueId" label="逾期订单" align="center"  width="70"></el-table-column>
            <el-table-column prop="totalPenalty" label="逾期金额" align="center"  min-width="70"></el-table-column>
            <el-table-column prop="mobile" label="手机号" align="center"   min-width="100"></el-table-column>
            <el-table-column prop="statementDate" label="逾期天数" align="center"   min-width="70"></el-table-column>
            <el-table-column prop="idNo" label="身份证" align="center"   min-width="150"></el-table-column>
            <el-table-column prop="loanAmount" label="提现金额" align="center"   min-width="70"></el-table-column>
            <el-table-column prop="name" label="姓名" align="center"   min-width="70"></el-table-column>
            <el-table-column prop="asid" label="是否外包" align="center"   min-width="70">
            ...
            <el-table-column prop="提现时间" label="提现时间" align="center"  min-width="150">
                <template slot-scope="scope">
