<template>
    <div class="container">
        ...
        <el-table-column
            ...
            <el-table-column prop="custUserId" label="客户id" align="center" width="70"></el-table-column>
            <el-table-column prop="custUserName" label="姓名" align="center" min-width="70"></el-table-column>
          
            <el-table-column prop="passedTime" label="审核通过时间" align="center" min-width="140">
            ...
            <el-table-column prop="userNumber" label="使用次数" align="center" min-width="80">
            </el-table-column>            
            <el-table-column prop="overdueNumber" label="逾期次数" align="center" min-width="80">
    
            </el-table-column>
            <el-table-column prop="lastUseTime" label="最后使用时间" align="center" min-width="140">
                <template slot-scope="scope">
            ...
            <el-table-column prop="lastGetCouponTime" label="优惠卷最后获得时间" align="center" min-width="150">
                <template slot-scope="scope">
