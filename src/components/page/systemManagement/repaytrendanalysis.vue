<template>
    <div class="container">
        ...
        <el-table
          ...
          >
            <el-table-column prop="withdrawdateString"  align="center" width="90"></el-table-column>
            <el-table-column  prop="allSalesMoney" label="销售量" align="center" min-width="86">
                <el-table-column label="销售额" align="center"  min-width="86">
                    <el-table-column label="放款额" align="center"  min-width="86">
            ...
            <template v-for="(temp,index) in dateArr">
              <el-table-column :key='index'  prop="allSalesMoney" :label="temp" align="center" min-width="90">
                        <template slot-scope="scope" >
                          <template v-if="scope.row[temp]">
                                  <span style="color:#527F88">{{scope.row[temp].alreadyRepayNumber}}</span><br>
                                  <span style="color:#527F88">{{scope.row[temp].needRepayMoney}}</span><br>
                                  <span style="color:#527F88">{{scope.row[temp].alreadyRepayLatefree &lt; 0? 0 :scope.row[temp].alreadyRepayLatefree}}</span><br>
            ...
            <el-table-column prop="alreadyRepayTotalSalesMoney" label="已回款"  align="center" min-width="70"></el-table-column>
            <el-table-column prop="needRepayTotalSalesMoney" label="待回款"  align="center" min-width="70">
                        <template slot-scope="scope">
                            {{scope.row.totalSalesMoney + scope.row.alreadyRepayotalLatefree-scope.row.alreadyRepayTotalSalesMoney}}
                        </template> 
            </el-table-column>
            <el-table-column prop="withdrawdateString" label="总滞纳金"  align="center" min-width="70">
                        <template slot-scope="scope">
                            {{scope.row.alreadyRepayotalLatefree &lt; 0 ? 0 : scope.row.alreadyRepayotalLatefree}}
                        </template>
            </el-table-column>
            <el-table-column prop="withdrawdateString" label="未还占比"  align="center" min-width="70">
                        <template slot-scope="scope">
            ...
            <el-table-column prop="withdrawdateString" label="回款率"  align="center" min-width="70">
                       <template slot-scope="scope">
                           ...
                           {{((((scope.row.alreadyRepayTotalSalesMoney))/scope.row.totalCostsMoney).toFixed(4)*100).toFixed(2)}}%
                        </template>
            </el-table-column>                   
        </el-table>
