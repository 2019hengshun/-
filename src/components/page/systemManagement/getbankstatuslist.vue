...
<template>
    <div class="container">
        ...
        <el-table
            ...
            <el-table-column prop="bankFlag" label="简称" align="center" min-width="70"></el-table-column>
            <el-table-column prop="bankDetail" label="银行" align="center"  min-width="80"></el-table-column>
            <el-table-column prop="asid" label="开启状态" align="center"  min-width="70">
