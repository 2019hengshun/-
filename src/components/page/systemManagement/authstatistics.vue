<template>
    <div class="container">
        ...
        <el-table
            ...
            v-loading="loading"
          >
            <el-table-column prop="dateString" fixed label="日期" align="center"   width="90"></el-table-column>
            <el-table-column prop="stepOne" label="ocr识别" align="center"  min-width="90"></el-table-column>
            <el-table-column prop="stepTwo" label="银行卡绑定" align="center" min-width="90"></el-table-column>
            <!-- <el-table-column prop="stepThree" label="录音" align="center" min-width="120"></el-table-column> -->
            <el-table-column prop="stepThree" label="人脸识别" align="center" min-width="90"></el-table-column>
            <el-table-column prop="stepFour" label="运营商认证" align="center" min-width="90"></el-table-column>
            <el-table-column prop="stepFive" label="芝麻信用" align="center" min-width="90"></el-table-column>
        </el-table>  
