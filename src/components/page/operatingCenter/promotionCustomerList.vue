    ...
    <div class="container"  v-loading="sloading">
        ...
        <el-row class="m20">
            <el-table
                ...
                <el-table-column prop="id" fixed  align="center" label="ID"  width="80"  ></el-table-column>
                ...
                <el-table-column prop="createTimeStr" align="center" label="创建时间"   width="160"></el-table-column>
