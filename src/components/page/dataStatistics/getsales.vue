    ...
    <el-tab-pane label="提现金额列表" name="three">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="createTime" label="提现时间" align="center" min-width="150"  >
                <template slot-scope="scope">
            ...
            <el-table-column prop="raise_money" label="提现金额" align="center" min-width="70" >
            </el-table-column>  
            <el-table-column prop="withdrawMoney" label="实际到款金额" align="center" min-width="95" >
            </el-table-column>  
            <el-table-column prop="coupon_value" label="优惠券面值" align="center" min-width="90" >
                <template slot-scope="scope">
