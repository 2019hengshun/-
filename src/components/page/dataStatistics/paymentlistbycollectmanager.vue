    ...
    <div class="container">
      <el-row>
        ...
        <el-table
            ...
            id="eleTable"
          >
            <el-table-column prop="userName" fixed label="姓名" align="center"   width="70"   ></el-table-column>
            ...
            <el-table-column prop="createTime" label="申请时间" align="center" min-width="140"  >
                <template slot-scope="scope">
            ...
            <el-table-column prop="reduceMoney" label="减免金额" align="center" min-width="70"  >
            </el-table-column>
            <el-table-column prop="withdrawMoney" label="实际到款金额" align="center" min-width="95"  >
            </el-table-column>
            <el-table-column prop="returnMoney" label="借款金额" align="center" min-width="70"  >
            </el-table-column>
            <el-table-column prop="late_fee" label="违约金" align="center" min-width="70"  >
            </el-table-column>
