...
<el-tabs type="border-card"   v-model="activeName" @tab-click="handleClick" v-loading="lodings">
    <el-tab-pane label="线上还款列表" name="three">
        ...
        <el-table
         ...
         <el-table-column prop="userName" fixed label="姓名" align="center" min-width="70" >
           ...
           <el-table-column prop="id_no" label="身份证" align="center" min-width="150" >
                                                      <template slot-scope="scope">
                    {{scope.row.id_no }}
                </template>
            </el-table-column>              
            <el-table-column prop="card_id_card" label="银行卡号" align="center" min-width="155" >
            </el-table-column>  
            <el-table-column prop="bank_card_name" label="银行名" align="center" min-width="80" >
            </el-table-column> 
            <el-table-column prop="raise_money" label="客户提现金额" align="center" min-width="95" >
            </el-table-column>  
            <el-table-column prop="withdrawMoney" label="实际到款金额" align="center" min-width="95" >
            </el-table-column>  
            <el-table-column prop="realMoney" label="实际还款金额" align="center" min-width="95" >
            </el-table-column>  
            <el-table-column prop="late_fee" label="滞纳金" align="center" min-width="70" >
            </el-table-column>                          
            <el-table-column prop="coupon_value" label="优惠券" align="center" min-width="70" >
                <template slot-scope="scope">
            ...
            <el-table-column prop="baofuapplyId" label="商户订单号" align="center" min-width="90" >
                                      <template slot-scope="scope">
            ...
            <el-table-column prop="createTime" label="还款时间" align="center" min-width="140" >
                <template slot-scope="scope">
                    {{scope.row.createTime|dateServer}}
                </template>              
            </el-table-column>    
            <el-table-column prop="collectName" label="催收员" align="center" min-width="70" >
            </el-table-column>                                                                                                      
            <el-table-column prop="status" label="还款类型" align="center" min-width="90"
            ...
            <el-table-column prop="trans_remark" label="备注" align="center" min-width="100" >
                <template slot-scope="scope">
    ...
    <el-tab-pane label="线下还款列表" name="four">
        ...
        <el-table
         ...
         <el-table-column prop="userName" fixed label="姓名" align="center" min-width="70" >
           ...
           <el-table-column prop="id_no" label="身份证" align="center" min-width="150" >
            ...
            <el-table-column prop="raise_money" label="合同金额" align="center" min-width="70" >
            </el-table-column>             
            <el-table-column prop="withdrawMoney" label="实际到款金额" align="center" min-width="95" >
            </el-table-column>             
            <el-table-column prop="ned_return_money" label="需要还款金额" align="center" min-width="95" >
              <template slot-scope="scope">
        ...
        <el-table-column prop="late_fee" label="滞纳金" align="center" min-width="70" >
            ...
            <el-table-column prop="returnMoney" label="实际还款金额" align="center" min-width="95" >
            </el-table-column>   

            <el-table-column prop="realRepmnentDate" label="实际还款日期" align="center" min-width="140" >
                <template slot-scope="scope">
                    {{scope.row.realRepmnentDate|dateServer}}
                </template>               
            </el-table-column> 
            <el-table-column prop="returnTime" label="应还款日" align="center" min-width="140" >
                <template slot-scope="scope" >
            ...
            <el-table-column prop="remarks" label="描述" align="center" min-width="100" >
                                      <template slot-scope="scope">
