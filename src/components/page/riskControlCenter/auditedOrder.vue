		...
		<el-tabs type="border-card" v-model="activename" class="m20" @tab-click="handleClick">
			...
			<el-table v-loading="loading" :data="tableData" class="textContent m20" ref="multipleTable" @selection-change="handleSelectionChange"
			 highlight-current-row style="width: 100%;font-weight:bold" border>
				...
				<el-table-column label="贷款状态" align="center" min-width="120">
					<template slot-scope="scope">
						<span>
              ...
              :scope.row.status===7?'还款':'完结'}}
				...
				<el-table-column prop="applyAmt" label="授信额度" align="center" min-width="70"></el-table-column>
				<el-table-column prop="approveAmt" label="通过金额" align="center" min-width="70"></el-table-column>
				<el-table-column label="审核结果" align="center" min-width="120">
					<template slot-scope="scope">
              ...
              :scope.row.approveResult===4?'人工审核不通过':'大数据风控中'}}
				...
				<el-table-column prop="approverName" label="审核经理" align="center" min-width="70"></el-table-column>
              ...
              :scope.row.applyStatus===4?'高风险用户':'审核完成'}}
				...
				<el-table-column prop="channel" label="渠道" align="center" min-width="100"></el-table-column>
						...
						<td colspan="5">
							<el-table :data="customerInformation" border highlight-current-row style="width: 100%;font-weight:bold">
								...
								<el-table-column prop="chbstatus" align="center" label="状态" width="80">
									<template slot-scope="scope">
										<el-tag :type="scope.row.chbstatus===1?'success':scope.row.chbstatus===0?'danger':''">
