      ...
      <el-dialog
        ...
        >
          <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <div  v-if="reportList" class="xy_title" style="margin-top:20px;">新颜报告</div>
            <el-row v-if="reportList">
              ...
              <div v-if="reportList" class="xy_title" style="margin-top:20px;">规则命中详情</div>
...
export default {
  ...
  methods: {
    ...
    submitCustomerInfo() {
      ...
      if (
        value != "" &&
        (value >= this.chooseMoneyVo.minMoney &&
