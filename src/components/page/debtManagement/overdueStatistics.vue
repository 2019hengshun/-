  ...
  <div class="container">
    ...
    <el-row class="m20">
      ...
      <el-table
        ...
        <el-table-column prop="username" fixed align='center' label="审核员" width="70"></el-table-column>
        <el-table-column prop="applyNumber" align='center' label="订单总数" min-width="70"></el-table-column>
        <el-table-column prop="allOverdueMoney" align='center' label="总逾期本金" min-width="90"></el-table-column>
        <el-table-column prop="allLate_free" align='center' label="总逾期违约金" min-width="95"></el-table-column>
        <el-table-column align='center' label="m1逾期订单" min-width="95">
          <template slot-scope="scope">
            <span>{{((scope.row.overdueApplyNumber_m1/scope.row.applyNumber).toFixed(4)*100).toFixed(2)}}%</span>
          </template>
        </el-table-column>
        <el-table-column prop="allOverdueMoney_m1" align='center' label="m1本金总额" min-width="95"></el-table-column>
        <el-table-column prop="allLate_free_m1" align='center' label="m1违约金" min-width="95"></el-table-column>
        <el-table-column align='center' label="m2逾期订单" min-width="95">
          <template slot-scope="scope">
            <span>{{((scope.row.overdueApplyNumber_m2/scope.row.applyNumber).toFixed(4)*100).toFixed(2)}}%</span>
          </template>
        </el-table-column>
        <el-table-column prop="allOverdueMoney_m2" align='center' label="m2本金总额" min-width="95"></el-table-column>
        <el-table-column prop="allLate_free_m2" align='center' label="m2违约金" min-width="95"></el-table-column>
        <el-table-column align='center' label="m3逾期订单" min-width="95">
          <template slot-scope="scope">
            <span>{{((scope.row.overdueApplyNumber_m3/scope.row.applyNumber).toFixed(4)*100).toFixed(2)}}%</span>
          </template>
        </el-table-column>
        <el-table-column prop="allOverdueMoney_m3" align='center' label="m3本金总额" min-width="95"></el-table-column>
        <el-table-column prop="allLate_free_m3" align='center' label="m3违约金" min-width="95"></el-table-column>
        <el-table-column align='center' label="m3+逾期订单" min-width="95">
          <template slot-scope="scope">
            <span>{{((scope.row.overdueApplyNumber_m4/scope.row.applyNumber).toFixed(4)*100).toFixed(2)}}%</span>
          </template>
        </el-table-column>
        <el-table-column prop="allOverdueMoney_m4" align='center' label="m3+本金总额" min-width="95"></el-table-column>
        <el-table-column prop="allLate_free_m4" align='center' label="m3+违约金" min-width="95"></el-table-column>
      </el-table>
    </el-row>
  </div>
</template>
