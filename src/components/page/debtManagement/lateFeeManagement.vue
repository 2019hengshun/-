<template>
    <div class="container">
        ...
        <el-row class="m20 " id="el-input__inner" >
    
             


          
          <el-form :inline="true" :model="search" class="demo-form-inline zljgl">
                  <el-form-item>
                ...
                <el-form-item >
                    <el-select  v-model="search.cust_id" placeholder="催收员" >
                      <el-option
...
<el-form :inline="true" :model="search" class="demo-form-inline">                   -->
                <el-form-item >
                    <el-select  v-model="search.paymentStatus" placeholder="还款状态" >
                      <el-option
                ...
                <!-- <div class="l20">
                    <el-input
                    style="padding:0px 10px 0px 0px;width:128px;"
                      placeholder="手机号"
                      v-model="search.phonenumber"
                      clearable>
                    </el-input> 
                ...
                <div class="l20">
                  <el-input
                    ...
                    <el-select class="l20" v-model="search.cust_id" placeholder="催收员" style="width:128px;padding-left:0px;">
                      <el-option
                        v-for="item in trevewerlist"
                        :key="item.uid"
                        :label="item.username"
                ...
                <div class="l20">
                  <el-input
                       style="padding:0px 10px 0px 0px;width:178px;"
                         placeholder="身份证"
                         v-model="search.userName"
                         clearable>
                       </el-input>  
                </div>
                    <el-select class="l20" v-model="search.paymentStatus" placeholder="还款状态" style="width:128px;">
                      <el-option
                        v-for="item in paymentStatus"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                                     ...
                                     <el-select class="l20" v-model="search.execeedtimeType" placeholder="M值" style="width:128px;">
                      <el-option
                        v-for="item in execeedtimeTypes"
                        :key="item.value"
                        :label="item.label"
 ...
 <el-row class="m20 col-flex-end" >                  
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="return_day" label="应还款时间" align="center" min-width="100"  >
                <template slot-scope="scope">
                    {{scope.row.return_day|dateServer2}}
                </template>
            </el-table-column>
            <el-table-column prop="realRepaymentTime" label="实际还款时间" align="center" min-width="150"  >
                <template slot-scope="scope">
            ...
            <el-table-column prop="raise_money" label="客户提现金额" align="center" min-width="100"  ></el-table-column>             
            <el-table-column prop="withdraw_money" label="实际下款金额" align="center" min-width="100"  ></el-table-column>
    ...
    <el-table-column prop="overdue_days" label="M值" align="center" min-width="80">
            ...
            <el-table-column prop="return_money" label="应还款总额" align="center" min-width="95"  >
            </el-table-column>                                                
            <!-- <el-table-column prop="borrow_time" label="申请时间" align="center" width="180"  >
                <template slot-scope="scope">
                    {{scope.row.borrow_time|dateServer}}
                </template>
            </el-table-column> -->
            <el-table-column prop="coupon_value" label="优惠券面值" align="center" min-width="95" >
                <template slot-scope="scope">
            ...
            <el-table-column prop="collectorName" label="催收员" align="center" min-width="70">
                        <template slot-scope="scope">
