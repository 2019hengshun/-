    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="score" label="芝麻分" align="center" min-width="80"  >
            </el-table-column>  
            <!-- <el-table-column prop="registerIp" label="注册IP" align="center" width="140"  >
            </el-table-column>    -->
           <el-table-column prop="sourceTypeStr" label="来源" align="center" min-width="70" >
            </el-table-column>              
            <el-table-column prop="typeStr" label="用户类型" align="center" min-width="75"
                        :filters="[{ text: '有意向', value: '有意向' }, { text: '无意向', value: '无意向' }, { text: '弃用', value: '弃用' }]"
             :filter-method="filterTypeStr"
             >
            </el-table-column>   
             <el-table-column prop="userType" label="客户状态" align="center"  min-width="100">
              <template slot-scope="scope">
                  <el-tag
            ...
            <el-table-column prop="lastLoginTimeStr" label="最后登陆时间" align="center" min-width="140"  >
            </el-table-column>  
           <el-table-column prop="userCreateTimeStr" label="注册时间" align="center" min-width="140"  >
            </el-table-column>  
            <el-table-column prop="detailAddress" label="详细地址" align="center" min-width="120" >
                         <template slot-scope="scope">
