       ...
       @selection-change="handleSelectionChange"
          >
             ...
             width="55">   
                      ...
                      <el-table-column prop="custUserId" label="ID" align="center"      width="70"  ></el-table-column>
                      <el-table-column prop="phoneNumber" label="电话" align="center"       min-width="100"></el-table-column>
                      ...
                      <el-table-column prop="custUserName" label="客户姓名" align="center"  min-width="70"></el-table-column>
                      <el-table-column prop="userCreateTimeStr" label="注册时间" align="center"      min-width="140" ></el-table-column>                         
                      <el-table-column prop="typeStr" label="客户状态" align="center"       min-width="100">
                        <template slot-scope="scope">
                            <el-tag
                                :type="scope.row.type==1?'success':scope.row.type==2?'info':scope.row.type==3?'warning':scope.row.type==4?'danger':''"
                      ...
                      <el-table-column prop="money" label="所剩金额" align="center"       min-width="70"></el-table-column>                                         
                     <el-table-column prop="salesmanName" label="电销人员" align="center"       min-width="70"></el-table-column>                      
                      <!-- <el-table-column prop="detailAddress" label="客户住址" align="center"       width="150">
                          <template slot-scope="scope">
                      ...
                      <el-table-column prop="lastLoginTimeStr" label="最后登陆时间" align="center" width="140"  >
                       </el-table-column> -->

                      <el-table-column prop="promoter" label="渠道" align="center"       min-width="70"></el-table-column>
<!--  
            ...
            <el-table-column type="expand" label="回访详情" min-width="80" >
              <template slot-scope="props" >
                ...
                <el-table
                  ...
                  border 
                      highlight-current-row style="width: 100%;font-weight:bold"
                  >
                      <el-table-column prop="customName" fixed label="客户姓名" align="center"   width="100"></el-table-column>
                      <el-table-column prop="salesmanName" label="电销员姓名" align="center"   width="100"></el-table-column>
                      <el-table-column prop="recallType" label="回访类型" align="center"   width="100"></el-table-column>
                      <el-table-column prop="recallResult" label="回访内容" align="center"   ></el-table-column>
                      <el-table-column prop="updateTime" label="最近回访时间" align="center"   width="180">
                        <template slot-scope="scope">
        ...
        <el-dialog
          ...
          > 
                  ...
                  >
                      ...
                      <el-table-column prop="mobile" label="号码" align="center"       width="100"></el-table-column>
                    ...
                    <tr class="title_6" >
                        <td colspan="6">
                            <el-table
                                    ...
                                    id="textt"
                                >
                      <el-table-column prop="custUserId" fixed label="ID" align="center" width="80"  ></el-table-column>
                        ...
                        <td colspan="5" >
                            <template v-if='ddShow'>
                                <el-table
                                    ...
                                    <el-table-column prop="productName" align="center" label="类别"  width="100"></el-table-column>
                                    <el-table-column prop="actualPayFee" align="center"  label="消费记录" width="120"></el-table-column>
                                  <el-table-column prop="fromAddress"  align="center" label="起始地"      width="200" >
                                        <template slot-scope="scope">
                                    ...
                                    <el-table-column prop="toAddress"  align="center" label="目的地"      width="200">
                                        <template slot-scope="scope">
                    ...
                    <tr>
                        ...
                        <td colspan="5" >
                            <el-table
                                ...
                                <!-- <el-table-column prop="protocolNo"  label="宝付返还接口" align="center"      width="300" ></el-table-column> -->
