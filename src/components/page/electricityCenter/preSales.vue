          ...
          >
           <el-table-column
            ...
            <el-table-column prop="score" label="芝麻分" align="center" min-width="80"  >
                ...
                <el-table-column prop="custAuth"  align="center" label="认证步骤" min-width="100"  >
                  <template slot-scope="scope">
                      <el-tag
           ...
           <el-table-column prop="sourceTypeStr" label="来源" align="center" width="100" >
            ...
            <el-table-column prop="typeStr" label="用户类型" align="center" min-width="70"
           ...
           <el-table-column prop="userCreateTimeStr" label="注册时间" align="center" min-width="140"  >
            ...
            <el-table-column type="expand" label="回访详情" min-width="80" >
              <template slot-scope="props" >
                ...
                <el-table-column prop="cz"  align="center" label="操作"  min-width="360" >
                    <template slot-scope="scope">
                        <el-button
                            size="mini"
                            type="success"
