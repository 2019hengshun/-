<template>
    <div class="container">
        ...
        <el-table
            ...
            id="eleTable"
          >
            <el-table-column prop="id" fixed label="客户ID" align="center" width="70"  >
      
            </el-table-column>
            <el-table-column prop="customName" label="客户姓名" align="center" min-width="70" >
      
            </el-table-column> 
            <el-table-column prop="salesmanName" label="电销人员" align="center" min-width="70" >
      
            </el-table-column> 
            <el-table-column prop="recallType" label="回访方式" align="center" min-width="70" >
      
            </el-table-column> 
            <el-table-column prop="createTime" label="回访时间" align="center" min-width="140"  >
                  <template slot-scope="scope">
                    {{scope.row.createTime|dateServer}}
                </template> 
            </el-table-column> 
            <el-table-column prop="type" label="客户状态" align="center" min-width="70" >
      
            </el-table-column>                                                            
            <el-table-column prop="userMobile" label="客户电话" align="center" min-width="100"  >
      
            </el-table-column>  

            <el-table-column prop="recallResult" label="回访结果" align="center" min-width="180">
                         <template slot-scope="scope">
            ...
            <el-table-column prop="remark" label="回访备注" align="center" min-width="120" >
                               <template slot-scope="scope">
            ...
            <!-- <el-table-column prop="customName" label="客户姓名" align="center" width="180"  >
                <template slot-scope="scope">
