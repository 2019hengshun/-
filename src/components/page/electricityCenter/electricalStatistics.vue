<template>
    <div class="container">
        ...
        <el-table
            ...
            id="eleTable"
          >
            <el-table-column prop="custUserId" fixed label="用户id" align="center" width="70"  >
            </el-table-column> 
            <el-table-column prop="custUserName" label="客户姓名" align="center" min-width="70" >
            </el-table-column> 
            <el-table-column prop="totalMoney" label="贷款金额" align="center" min-width="70"  >
            </el-table-column> 
            <el-table-column prop="interest" label="平台服务费" align="center" min-width="90"  >
            </el-table-column> 
            <el-table-column prop="loanDateStr" label="提款时间" align="center" min-width="140"  >
            </el-table-column>             
            <el-table-column prop="bankCardId" label="到账卡号" align="center" min-width="150" >
            </el-table-column> 
            <el-table-column prop="bankCardName" label="所属银行" align="center" min-width="80" >
            </el-table-column> 
            <el-table-column prop="bankCardMobile" label="银行预留手机号" align="center" min-width="110" >
            </el-table-column> 
            <!-- <el-table-column prop="salesmanId" label="电销员ID" align="center" width="180"  >
            </el-table-column>  -->
            <el-table-column prop="salesmanName" label="电销员姓名" align="center" min-width="90" >
            </el-table-column> 
            <!-- <el-table-column prop="salesmanId" label="电销员ID" align="center" width="180"  >
            </el-table-column>                                                                                                                    -->
        ...
        <el-table
            ...
            v-loading="loadings"
          >
            <el-table-column prop="salesmanId" label="ID" align="center" width="80"  >
            </el-table-column> 
            ...
            <el-table-column prop="loanfirstMoney" label="首次借款金额 " align="center" min-width="100"  >
            </el-table-column> 
            <el-table-column prop="loanRepurchaseMoney" label="复购借款金额" align="center" min-width="110"  >
            </el-table-column> 
        </el-table>              
        </el-dialog>                                       
    </div>
