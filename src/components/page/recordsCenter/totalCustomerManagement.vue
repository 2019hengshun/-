        ...
        <el-row class="m20">
            <el-table
              ...
              >
                ...
                <el-table-column prop="idcard"  align="center" label="身份证号" width="150" >
               
                </el-table-column>
                <!-- <el-table-column prop="em"  align="center" label="Email"   ></el-table-column> -->
                <el-table-column prop="phoneNumber"  align="center" label="手机号"  width="100" ></el-table-column>
                ...
                <el-table-column prop="channel"  align="center" label="渠道名" width="70"  ></el-table-column>    
                ...
                <el-table-column prop="lastLoginTime"  align="center" label="上次登录时间"  width="140"   >
                  <template slot-scope="scope">
                      {{scope.row.lastLoginTime|dateServer}}
                  </template>                  
                </el-table-column>                            
                <el-table-column prop="detailAddress"  align="center" label="详细地址" width="120"  >
                        <template slot-scope="scope">
                ...
                <el-table-column prop="createTime"  align="center" label="注册时间"  width="140"   >
                  <template slot-scope="scope">
                ...
                <el-table-column prop="cz"  align="center" label="操作"  min-width="220" >
                    <template slot-scope="scope">
                    <el-button
                        size="mini"
                        type="success"
