    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="realName" label="用户姓名" align="center"  width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney" label="短信类型" align="center"  min-width="100">
            ...
            <el-table-column prop="createTime" label="发送时间" align="center" min-width="140"  >
                <template slot-scope="scope">
            ...
            <el-table-column prop="content" label="内容" align="center"  min-width="300">
                        <template slot-scope="scope">
