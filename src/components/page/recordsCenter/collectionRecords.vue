    ...
    <el-tabs type="border-card" class="m20"  v-model="activeName" @tab-click="handleClick" v-loading="lodings">
      <el-tab-pane label="催收统计" name="first">         
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="name" label="催收员" align="center"    min-width="70"></el-table-column>
            <el-table-column prop="allOverdueMoney" label="催收本金" align="center"    min-width="70"></el-table-column>
            <el-table-column prop="all_late_fee" label="应催收违约金" align="center"   min-width="100"> </el-table-column>
            <!-- <el-table-column prop="borrowTime" label="借款时间" align="center" width="180"  >
                <template slot-scope="scope">
                    {{scope.row.borrowTime|dateServer}}
                </template>
            </el-table-column> -->
            <el-table-column prop="borrowDay" label="催回总金额" align="center"    min-width="90">
                <template slot-scope="scope">
                    {{scope.row.collect_money_m1+scope.row.collect_money_m2+scope.row.collect_money_m3+scope.row.collect_money_m4}}
                </template>
            </el-table-column>
             <el-table-column prop="allCollectNumber" label="总数量" align="center"    min-width="80"></el-table-column>
            <el-table-column prop="collect_money_m1" label="M1" align="center"  min-width="110"  >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m1_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m1}}
                </template>
            </el-table-column>
            <el-table-column prop="collect_money_m2" label="M2" align="center"  min-width="110"  >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m2_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m2}}
                </template>              
            </el-table-column>
            <el-table-column prop="collect_money_m3" label="M3" align="center"  min-width="110"   >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m3_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m3}}
                </template>              
            </el-table-column>
            <el-table-column prop="collect_money_m4" label="M3+" align="center"  min-width="110"   >
             <template slot-scope="scope">
                    {{scope.row.overdueMoney_m4_number}}个 &nbsp; &nbsp; &nbsp; {{scope.row.collect_money_m4}}
                </template>              
            </el-table-column>
            <el-table-column prop="collect_money_m4" label="支付宝还款" align="center"  min-width="110"   >
             <template slot-scope="scope">
      ...
      <el-tab-pane label="催收列表成功展示" name="second"> 
        <el-row class="m20" >
            ...
            id="eleTable"
          >
             <el-table-column prop="id" fixed label="ID号" align="center" width="70" >
            </el-table-column> 
             <el-table-column prop="userName" label="姓名" align="center" min-width="70" >
            </el-table-column> 
             <el-table-column prop="id_no" label="身份证号" align="center" min-width="150" >
                                                        <template slot-scope="scope">
                    {{scope.row.id_no }}
                </template>
            </el-table-column> 
             <el-table-column prop="returnTime" label="应还款日" align="center"  min-width="90" >
                <template slot-scope="scope">
                    {{scope.row.returnTime|dateServer2}}
                </template>               
            </el-table-column> 
             <el-table-column prop="createTime" label="实际还款时间" align="center" min-width="140">
               <template slot-scope="scope">
                    {{scope.row.createTime|dateServer}}
                </template>   
            </el-table-column> 
             <el-table-column prop="raise_money" label="商品金额" align="center" min-width="70"  >
            </el-table-column> 
             <el-table-column prop="late_fee" label="应还滞纳金" align="center" min-width="90"  >
            </el-table-column> 
             <el-table-column prop="overdue_day" label="逾期天数" align="center" min-width="70"  >
            </el-table-column>  
             <el-table-column prop="m" label="M值" align="center" min-width="70" >
                  <template slot-scope="scope">
                    {{scope.row.overdue_day==0?'':scope.row.overdue_day < 11?'M1':scope.row.overdue_day < 21?'M2':scope.row.overdue_day < 31?'M3':'M3+'}}
                </template>               
            </el-table-column>  
             <el-table-column prop="realMoney" label="实际还款金额" align="center" min-width="140"  >
               <!-- <template slot-scope="scope">                         
             ...
             <el-table-column prop="reduceMoney" label="减免金额" align="center" min-width="80"  >
            </el-table-column>                                                                                                                                     
          </el-table>  
            <el-row class="m20" v-if="total>0">
                 <div style="float:right">
