    ...
    <div class="container">
        ...
        <el-table
          ...
          >
            ...
            <!-- <el-table-column prop="custUserId" label="用户ID" width="100" align="center"   ></el-table-column> -->
            <el-table-column prop="custUserName" label="客户名"  min-width="70" align="center"  ></el-table-column>
            <el-table-column prop="createTime" label="创建时间"  align="center" min-width="140"  >
                <template slot-scope="scope">
                    {{scope.row.createTime|dateServer}}
                </template>
            </el-table-column>
            <el-table-column prop="opinion" label="反馈" align="center"  min-width="260">
                        <template slot-scope="scope">
            ...
            <el-table-column prop="phoneNumber" label="手机号码" align="center" min-width="100"   ></el-table-column>
            <!-- <el-table-column prop="id" label="是否已读" align="center"   ></el-table-column> -->
            ...
            <el-table-column type="expand" label="详情" min-width="80" >
              <template slot-scope="props" >
