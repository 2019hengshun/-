    ...
    <div class="container" id="repaymentRecordManagement">
        ...
        <el-table
          ...
          >
            ...
            <el-table-column prop="type" label="还款类型" align="center" min-width="100">
            ...
            <el-table-column prop="recordUrl" align="center"  label="还款记录图片"  min-width="90">
                <template slot-scope="scope">
            ...
            <el-table-column prop="daysOverdue" label="逾期天数" align="center" min-width="70" ></el-table-column>
            <el-table-column prop="interestOverdue" label="逾期利息" align="center" min-width="70"></el-table-column>
            <el-table-column prop="discountAmt" label="打折金额" align="center" min-width="70"></el-table-column>
            <el-table-column prop="mustPayBackAmt" label="应还款" align="center" min-width="70"></el-table-column>
            <el-table-column prop="actualPayBackAmt" label="实际还款" align="center" min-width="70"></el-table-column>
            <el-table-column prop="backDate" label="还款日期" align="center" min-width="150">
                <template slot-scope="scope">
            ...
            <el-table-column prop="createTime" label="记录创建时间" align="center" min-width="140">
                <template slot-scope="scope">
                    {{scope.row.createTime|dateServer}}
                </template>
            </el-table-column>
            <el-table-column prop="custname" label="客户名" align="center" min-width="70"></el-table-column>
            <el-table-column prop="username" label="催收人姓名" align="center"  min-width="90"></el-table-column>            
            <el-table-column prop="success" label="是否还款成功" align="center" min-width="100">
                <template slot-scope="scope">              
                    <el-tag
